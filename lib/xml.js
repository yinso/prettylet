...
(function() {
  ...
  KeyValTab = (function(_super) {
    ...
    function KeyValTab(key, val, delim) {
      ...
      this.val = new pretty.Literal(val, function(v) {
        return JSON.stringify(v);
      });
    }

    KeyValTab.prototype.oneLine = function(buffer, level) {
      buffer.pushOneLine(this.key, this.delim);
      return this.val.oneLine(buffer, level);
    };

    KeyValTab.prototype.multiLine = function(buffer, level) {
      buffer.push(this.key, this.delim);
  ...
  ElementTab = (function(_super) {
    ...
    ElementTab.prototype._multiLineOpen = function(buffer, level) {
      if (this.attrs.length === 0) {
        ...
        this.attrs.multiLine(buffer, level + 2);
        return buffer.push(">");
      }
    };
